        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('FORGET YOUR',style: TextStyle(color: Colors.white,fontSize: 38,),),
              const Text('PASSWORD?',style: TextStyle(color: Colors.white,fontSize: 38,),),
              const Text('No Worries , We will Send The Code To Reset Your Password ',style: TextStyle(color:Colors.white60),),
            Container(
                  ...
                  child:Padding(
                    ...
                    child: Column(
                      ...
                      children:[
                        ...
                        button(text: 'SEND CODE', onPressed: (){}, backgroundColor: const Color(0x42FFFFFF)),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            spacing:5,
                            children: [
                              Text('Remember Your Password?',style: TextStyle(color: Colors.white,fontSize: 15),),
                              Text('Back to login',style: TextStyle(color: Colors.yellow,fontSize: 15),)
                            ],
                          ),
                        ),
                      ]
